...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pages/property-detail/property-detail.api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.insertContact = exports.getEquipment = exports.getPropertyDetails = void 0;
...
var urlEquipments = "".concat("http://localhost:3000/api", "/equipments");
var urlContact = "".concat("http://localhost:3000/api", "/contact");

var getPropertyDetails = function getPropertyDetails(id) {
...
var getEquipment = function getEquipment() {
  return _axios.default.get(urlEquipments).then(function (response) {
    return response.data;
  });
};
...
var insertContact = function insertContact(contact) {
  return _axios.default.post(urlContact, contact).then(function (response) {
    return response.data;
  });
};

exports.insertContact = insertContact;
},{"axios":"../node_modules/axios/index.js"}],"../node_modules/qs/lib/utils.js":[function(require,module,exports) {
'use strict';
...
},{"qs":"../node_modules/qs/lib/index.js"}],"pages/property-detail/property-detail.mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapContactFormFromViewModelToApi = exports.mapPropertyFromApiToViewModel = void 0;

var mapPropertyFromApiToViewModel = function mapPropertyFromApiToViewModel(property, equipmentList) {
  return {
    id: property.id,
    title: property.title,
    rooms: "".concat(property.rooms, " ").concat(getRoomWord(property.rooms)),
    squareMeters: "".concat(property.squareMeters, "m2"),
    notes: "".concat(property.notes),
...
exports.mapPropertyFromApiToViewModel = mapPropertyFromApiToViewModel;

var mapContactFormFromViewModelToApi = function mapContactFormFromViewModelToApi(contact) {
  return {
    email: contact.email,
...
exports.mapContactFormFromViewModelToApi = mapContactFormFromViewModelToApi;
...
var equivalentId = function equivalentId(property, equipmentList) {
  var equivalent = "";
  equivalent = property.equipmentIds.map(function (obj) {
    var find = equipmentList.find(function (element) {
...
exports.setPropertyValues = void 0;

var setMainFeatures = function setMainFeatures(property) {
  var list = document.getElementById('mainFeatures');
  property.mainFeatures.forEach(function (mainFeature) {
...
var setImages = function setImages(property) {
  var list = document.getElementById('images');
  property.images.forEach(function (image, id) {
    var li = document.createElement('li');
    li.id = "image".concat(id);
    var img = getImage(image, id);
    var overlayImg = getOverlayImage(image, id);
    li.appendChild(img);
...
var getImage = function getImage(image, id) {
  var container = document.createElement('div');
  container.classList.add('mosaicItem');
  var anchor = document.createElement('a');
  anchor.href = "#popin".concat(id);
...
var getOverlayImage = function getOverlayImage(image, id) {
  var container = document.createElement('div');
  container.classList.add('popin');
  container.id = "popin".concat(id);
  var anchor = document.createElement('a');
  anchor.href = "#image".concat(id);
...
var setPropertyValues = function setPropertyValues(property) {
...
exports.setPropertyValues = setPropertyValues;
...
},{}],"pages/property-detail/property-detail.validations.js":[function(require,module,exports) {
"use strict";
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/property-detail/property-detail.js":[function(require,module,exports) {
"use strict";

var _propertyDetail = require("./property-detail.api");

var _history = require("../../core/router/history");

var _propertyDetail2 = require("./property-detail.mapper");

var _propertyDetail3 = require("./property-detail.helpers");

var _element = require("../../common/helpers/element.helpers");

var _propertyDetail4 = require("./property-detail.validations");
...
Promise.all([(0, _propertyDetail.getPropertyDetails)(params.id), (0, _propertyDetail.getEquipment)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
      apiPropertyDetails = _ref2[0],
      apiEquipments = _ref2[1];

  var viewPropertyDetails = (0, _propertyDetail2.mapPropertyFromApiToViewModel)(apiPropertyDetails, apiEquipments);
  (0, _propertyDetail3.setPropertyValues)(viewPropertyDetails);
...
(0, _element.onUpdateField)("email", function (event) {
  ...
  _propertyDetail4.formValidation.validateField("email", contact.email).then(function (result) {
...
(0, _element.onUpdateField)("message", function (event) {
  ...
  _propertyDetail4.formValidation.validateField("message", contact.message).then(function (result) {
    (0, _element.onSetError)("message", result);
  });
});

var onContact = function onContact() {
  var apiContact = (0, _propertyDetail2.mapContactFormFromViewModelToApi)(contact);
  return (0, _propertyDetail.insertContact)(apiContact);
};
...
(0, _element.onSubmitForm)("contact-button", function () {
  ...
  _propertyDetail4.formValidation.validateForm(contact).then(function (result) {
    (0, _element.onSetFormErrors)(result);

    if (result.succeeded) {
      onContact().then(function (apiContact) {
        _history.history.back;
      });
    }
  });
});
},{"./property-detail.api":"pages/property-detail/property-detail.api.js","../../core/router/history":"core/router/history.js","./property-detail.mapper":"pages/property-detail/property-detail.mapper.js","./property-detail.helpers":"pages/property-detail/property-detail.helpers.js","../../common/helpers/element.helpers":"common/helpers/element.helpers.js","./property-detail.validations":"pages/property-detail/property-detail.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/property-detail/property-detail.js"], null)
//# sourceMappingURL=/property-detail.61d3fc34.js.map