...
var saleTypeListUrl = "".concat("http://localhost:3000/api", "/saleTypes"); //si vas al package json  en start por
...
exports.mapFilterToQueryParams = exports.mapPropertyListFromApiToVm = void 0;
...
var mapPropertyFromApiToVm = function mapPropertyFromApiToVm(property) {
  return {
    ...
    image: Array.isArray(property.images) ? property.images[0] : "" //se hace porque si no es un array no salga error
...
var mapFilterToQueryParams = function mapFilterToQueryParams(filter) {
  ...
  if (filter.saleTypeId) {
    queryParams = "".concat(queryParams, "salesTypeIds_like=").concat(filter.saleTypeId, "&"); //     //en el array salestype busca el id que te estoy dando yo filter.saleTypeId
  }
  ...
  if (filter.minRooms) {
    queryParams = "".concat(queryParams, "rooms_gte=").concat(filter.minRooms, "&"); //     //busca en el array el valor mayor o igual que te doy en el filtro
  }
  ...
  if (filter.minPrice) {
    queryParams = "".concat(queryParams, "minPrice_gte=").concat(filter.min.Price, "&");
  }

  if (filter.maxPrice) {
    queryParams = "".concat(queryParams, "maxPrice_lte=").concat(filter.maxPrice, "&");
  }
...
Promise.all([(0, _propertyList.getPropertyList)(), (0, _propertyList.getSaleTypeList)(), (0, _propertyList.getProvinceList)()]).then(function (_ref) {
  ...
  (0, _propertyList3.setOptions)(saleTypeList, "select-sale-type", "¿Que venta?");
  (0, _propertyList3.setOptions)(provinceList, "select-province", "¿Donde?");
  (0, _propertyList3.setOptions)(_propertyList4.roomOptions, "select-room", "¿habitaciones?");
  (0, _propertyList3.setOptions)(_propertyList4.bathroomOptions, "select-bathroom", "¿baños?");
  (0, _propertyList3.setOptions)(_propertyList4.maxPriceOptions, "select-max-price", "Min(EUR)");
  (0, _propertyList3.setOptions)(_propertyList4.minPriceOptions, "select-min-price", "Max(EUR)");
});
...
(0, _element.onUpdateField)("select-sale-type", function (event) {
  var value = event.target.value;
  filter = _objectSpread(_objectSpread({}, filter), {}, {
    saleTypeId: value
  });
});
(0, _element.onUpdateField)("select-province", function (event) {
  var value = event.target.value;
  filter = _objectSpread(_objectSpread({}, filter), {}, {
    provideId: value
  });
});
(0, _element.onUpdateField)("select-room", function (event) {
  var value = event.target.value;
  filter = _objectSpread(_objectSpread({}, filter), {}, {
    minRooms: value
  });
...
(0, _element.onUpdateField)("select-bathroom", function (event) {
  var value = event.target.value;
  filter = _objectSpread(_objectSpread({}, filter), {}, {
    minBathRooms: value
  });
});
(0, _element.onUpdateField)("select-min-price", function (event) {
  var value = event.target.value;
  filter = _objectSpread(_objectSpread({}, filter), {}, {
    minPrice: value
  });
});
(0, _element.onUpdateField)("select-max-price", function (event) {
  var value = event.target.value;
  filter = _objectSpread(_objectSpread({}, filter), {}, {
    maxPrice: value
  });
});
(0, _element.onSubmitForm)("search-button", function () {
  ...
  (0, _propertyList3.clearPropertyRows)(); //limpiamos el html del resultado anterior antes de añadir las proximas
