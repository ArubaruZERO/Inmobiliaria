...
var validationSchema = {
  field: {
    ...
    title: [_fonk.Validators.required],
    email: [{
...
exports.insertUploadData = exports.getEquipmentList = exports.getProvinceList = exports.getSaleTypeList = void 0;

var _axios = _interopRequireDefault(require("axios"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var saleTypeUrl = "".concat("http://localhost:3000/api", "/saleTypes");
...
var getSaleTypeList = function getSaleTypeList() {
  return _axios.default.get(saleTypeUrl).then(function (response) {
...
var getEquipmentList = function getEquipmentList() {
...
var insertUploadData = function insertUploadData(uploadData) {
  return _axios.default.post(url, uploadData).then(function (response) {
    return response.data;
  });
};

exports.insertUploadData = insertUploadData;
},{"axios":"../node_modules/axios/index.js"}],"pages/upload-property/upload-property.helpers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onAddImage = exports.onRemoveFeature = exports.onAddFeature = exports.formatDeleteFeatureButtonId = exports.setOptionList = exports.setCheckboxList = exports.formatCheckboxId = void 0;
...
},{}],"pages/upload-property/upload-property.mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapUploadDataFromVmToApi = void 0;

var mapUploadDataFromVmToApi = function mapUploadDataFromVmToApi(uploadData) {
  return {
    title: uploadData.title,
    notes: uploadData.notes,
    email: uploadData.email,
    phone: uploadData.phone,
    price: "".concat(uploadData.price, "-\u20AC"),
    salesTypes: uploadData.salesTypes,
    address: uploadData.address,
    city: uploadData.city,
    province: uploadData.province,
    squareMeter: "".concat(uploadData.squareMeter, "-m2"),
...
exports.mapUploadDataFromVmToApi = mapUploadDataFromVmToApi;
...
var _uploadProperty = require("./upload-property.validations");

var _uploadProperty2 = require("./upload-property.api");

var _uploadProperty3 = require("./upload-property.helpers");

var _uploadProperty4 = require("./upload-property.mapper");
...
Promise.all([(0, _uploadProperty2.getSaleTypeList)(), (0, _uploadProperty2.getProvinceList)(), (0, _uploadProperty2.getEquipmentList)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 3),
      saleTypeList = _ref2[0],
      provinceList = _ref2[1],
      equipmentList = _ref2[2];

  (0, _uploadProperty3.setCheckboxList)(saleTypeList, "saleTypes");
  (0, _uploadProperty3.setOptionList)(provinceList, "province");
  (0, _uploadProperty3.setCheckboxList)(equipmentList, "equipments");
});
var uploadData = {
  title: "",
  notes: "",
...
(0, _element.onUpdateField)("title", function (event) {
  ...
  uploadData = _objectSpread(_objectSpread({}, uploadData), {}, {
    title: value
  });

  _uploadProperty.formValidation.validateField("title", uploadData.title).then(function (result) {
    return (0, _element.onSetError)("title", result);
  });
});
(0, _element.onUpdateField)("notes", function (event) {
  ...
  _uploadProperty.formValidation.validateField("notes", uploadData.notes).then(function (result) {
    return (0, _element.onSetError)("notes", result);
  });
});
(0, _element.onUpdateField)("email", function (event) {
  ...
  _uploadProperty.formValidation.validateField("email", uploadData.email).then(function (result) {
    return (0, _element.onSetError)("email", result);
  });
});
(0, _element.onUpdateField)("phone", function (event) {
  ...
  _uploadProperty.formValidation.validateField("phone", uploadData.phone).then(function (result) {
    return (0, _element.onSetError)("phone", result);
  });
});
(0, _element.onUpdateField)("price", function (event) {
  ...
  _uploadProperty.formValidation.validateField("price", uploadData.price).then(function (result) {
    return (0, _element.onSetError)("price", result);
  });
});
(0, _element.onUpdateField)("saleTypes", function (event) {
  var value = event.target.value;
  uploadData = _objectSpread(_objectSpread({}, uploadData), {}, {
    saleTypes: value
  });
...
(0, _element.onUpdateField)("address", function (event) {
  ...
  _uploadProperty.formValidation.validateField("address", uploadData.address).then(function (result) {
    return (0, _element.onSetError)("address", result);
  });
});
(0, _element.onUpdateField)("city", function (event) {
  ...
  _uploadProperty.formValidation.validateField("city", uploadData.city).then(function (result) {
    return (0, _element.onSetError)("city", result);
  });
});
(0, _element.onUpdateField)("squareMeter", function (event) {
  ...
  _uploadProperty.formValidation.validateField("squareMeter", uploadData.squareMeter).then(function (result) {
    return (0, _element.onSetError)("squareMeter", result);
  });
});
(0, _element.onUpdateField)("rooms", function (event) {
  ...
  _uploadProperty.formValidation.validateField("rooms", uploadData.rooms).then(function (result) {
    return (0, _element.onSetError)("rooms", result);
  });
});
(0, _element.onUpdateField)("bathrooms", function (event) {
  ...
  _uploadProperty.formValidation.validateField("bathrooms", uploadData.bathrooms).then(function (result) {
    return (0, _element.onSetError)("bathrooms", result);
  });
});
...
(0, _element.onUpdateField)("locationUrl", function (event) {
  ...
  _uploadProperty.formValidation.validateField("locationUrl", uploadData.locationUrl).then(function (result) {
    return (0, _element.onSetError)("locationUrl", result);
  });
});
(0, _element.onUpdateField)("equipments", function (event) {
  var value = event.target.value;
  uploadData = _objectSpread(_objectSpread({}, uploadData), {}, {
    equipment: value
  });
...
(0, _element.onSubmitForm)("insert-feature-button", function () {
  ...
  if (value) {
    uploadData = _objectSpread(_objectSpread({}, uploadData), {}, {
      feature: [uploadData.feature, value]
    });
    (0, _uploadProperty3.onAddFeature)(value);
  }

  ;
  var id = (0, _uploadProperty3.formatDeleteFeatureButtonId)(value);
  (0, _element.onSubmitForm)(id, function () {
    (0, _uploadProperty3.onRemoveFeature)(value);
    var index = uploadData.saleTypes.indexOf(value);
    uploadData.saleTypes.splice(index, 1);
  });
}); //INSERTAR FOTOS

(0, _element.onAddFile)("add-image", function (image) {
  uploadData = _objectSpread(_objectSpread({}, uploadData), {}, {
    image: [].concat(_toConsumableArray(uploadData.images), [image])
  });
  (0, _uploadProperty3.onAddImage)(image);
}); //ENVIAR INFORMACION AL SERVIDOR

var onUploadData = function onUploadData() {
  var apiUploadData = (0, _uploadProperty4.mapUploadDataFromVmToApi)(uploadData);
  return (0, _uploadProperty2.insertUploadData)(apiUploadData);
};

(0, _element.onSubmitForm)("save-button", function () {
  _uploadProperty.formValidation.validateForm(uploadData).then(function (result) {
    ...
    if (result.succeeded) {
      onUploadData().then(function (apiUploadData) {
        history.back;
      });
    }
  });
});
},{"../../common/helpers/element.helpers":"common/helpers/element.helpers.js","./upload-property.validations":"pages/upload-property/upload-property.validations.js","./upload-property.api":"pages/upload-property/upload-property.api.js","./upload-property.helpers":"pages/upload-property/upload-property.helpers.js","./upload-property.mapper":"pages/upload-property/upload-property.mapper.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
